...
import static com.hms.referenceapp.workouts.ui.main.workouts.BaseActivity.*;

import static com.hms.referenceapp.workouts.ui.main.workouts.BaseActivity.setStatusBarColor;
import static com.hms.referenceapp.workouts.ui.main.workouts.TemplateActivity.getSelectedIndex;
...
public final class HumanSkeletonActivity extends AppCompatActivity
        ...
        public void handleMessage(Message msg) {
          ...
          HumanSkeletonActivity mainActivity = mMainActivityWeakReference.get();
            ...
            if (msg.what == UPDATE_VIEW) {
                ...
                int resultt = (int) (result * 100);
                if (resultt >= 80) {
                    preview.stop();
                    mainActivity.templateSimilarityTextView.setText("similarity:" + (int) (result * 100) + "%  ");
                    AlertDialog alertDialog;
                    alertDialog = new AlertDialog.Builder(HumanSkeletonActivity.this).create();
                    alertDialog.setTitle("GREAT !");
                    alertDialog.setMessage("You made the exercise correctly :)");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBarColor(this, R.color.hwid_auth_button_color_black);
